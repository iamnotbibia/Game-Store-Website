...
public class Product {
	...
	public Product(Integer id, String title, String description, String category, Double price, String dev, String image,
	...
	public String toString() {
		return "Product [id=" + id + ", title=" + title + ", description=" + description + ", category=" + category
				+ ", price=" + price + ", dev=" + dev + ", image=" + image + ", discount=" + discount
